...
urlpatterns = [
    ...
    path("solicitacoes/<int:pk>/reprovar/", views.reprovar_solicitacao, name="reprovar_solicitacao"),
    path("solicitacoes/<int:pk>/atender/", views.atender_solicitacao, name="atender_solicitacao"),
